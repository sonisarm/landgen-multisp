...
txt_file_path = os.path.join(script_dir, "../../Data/RawData/STRand-input-files-3.txt")  # List of files
# input txt file columns: file name, sheet name, output name, ploidy
# Example: "file.xlsx,Sheet1,output_name,4
